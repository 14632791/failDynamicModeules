...
namespace Metro.DynamicModeules.Core
{
    ...
    //{
    //    private MetroAnimatedTabControl _tabControlModules = null;

    //    /// <summary>
    //    /// 主窗体的MetroAnimatedTabControl控件, 用于集成模块的主窗体
    //    /// </summary>        
    //    public MetroAnimatedTabControl TabControlModules { get { return _tabControlModules; } }
        
    //    /// <summary>
    //    ///MDI主窗体对象引用
    //    /// </summary>
    //    private Window _MDIMainForm = null;
    ...
    //    /// <param name="tabControlModules">主窗体的MetroAnimatedTabControl控件</param>
    //    public ModuleManager(Window mdiMainForm, MetroAnimatedTabControl tabControlModules)
    //    {
    ...
    //                (loader.ModuleMainForm as Window).MdiParent = _MDIMainForm; //模块的主窗体也作为一个子窗体, 设置父窗体.                    
    //            }
    ...
    //    public void CreateNavBarButtons(NavBarControl navBarControl, Menu mainMenu)
    //    {
    ...
    //    {
    //        //显示模块容器窗体
    //        (_MDIMainForm as IMdiWindow).ShowModuleContainerForm();
    ...
    //            foreach (XtraTabPage page in this._tabControlModules.TabPages)
    //            {
    //                Window activeForm = (Window)page.Tag;
    //                if (null != activeForm)
