...
using Metro.DynamicModeules.WebServiceReference;
...
namespace Metro.DynamicModeules.BLL.Security
{
    ...
    public class BllUser : BllBaseDataDict
    {
        ...
        /// </summary>
        /// <returns></returns>
        private IBridgeUser CreateBridge()
        {
            if (BridgeFactory.BridgeType == BridgeType.ADODirect)
                return new ADODirectUser().GetInstance();
        ...
        {
          return  new WebService_User().GetVer();
        }
    }
}
