...
namespace Metro.DynamicModeules.BLL.Security
{
    ...
    public class NovellLdapTools
    {
        ...
        /// 获取Novell对象的属性
        /// </summary>
        /// <param name="NovellPath">Novell目录路径, 如:.edp.Metro.DynamicModeules.mo 或 .Metro.DynamicModeules.mo</param>
        ...
        /// 获取Novell网对象
        /// </summary>
        /// <param name="NovellPath">有效路径.如: .edp.Metro.DynamicModeules.mo 或 .Metro.DynamicModeules.mo</param>
