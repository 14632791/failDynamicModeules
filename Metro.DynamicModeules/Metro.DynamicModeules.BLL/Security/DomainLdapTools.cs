...
namespace Metro.DynamicModeules.BLL.Security
{
    ...
    public class DomainLdapTools
    {
        ...
        /// 从活动目录中搜索对象
        /// </summary>
        /// <param name="domainADPath">如：Metro.DynamicModeules.mo</param>
        ...
        /// 创建一个目录入口．
        /// </summary>
        /// <param name="domainADPath">AD路径,如：Metro.DynamicModeules.mo</param>
        /// <returns></returns>
        public static DirectoryEntry CreateDirectoryEntry(string domainADPath)
        {
            DirectoryEntry de = new DirectoryEntry(domainADPath); //Metro.DynamicModeules.mo
