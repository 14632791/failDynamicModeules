...
namespace Metro.DynamicModeules.BLL
{
    ...
    {
        private static tb_CompanyInfo _CompanyInfo = null;

        /// <summary>
        /// 公司资料
        /// </summary>
        public static tb_CompanyInfo CompanyInfo
        {
        ...
        public static List<string> GetAllDocNo(string DocNo)
        {
            ...
            DataTable tbl = null;// BridgeFactory.CreateCommonDataBridge().GetAllDocNo(DocNo);
